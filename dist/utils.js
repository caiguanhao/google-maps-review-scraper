 ...
 */
export async function fetchReviews(placeId, sort, nextPage = "", search_query = "", sessionToken) {
 ...
 * @param {string} sessionToken - The session token for authentication.
 */
export async function paginateReviews(placeId, sort, pages, search_query, clean, sessionToken) {
